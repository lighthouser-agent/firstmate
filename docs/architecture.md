...
`AGENTS.md` section 6 owns the complete knowledge-routing table.
The internal [`/stow` skill](../.agents/skills/stow/SKILL.md) owns the sweep, inspect-then-update, destination-landing, source-pointer, and cascade procedure.
